    ...
    <div className="w-full md:py-20">
      <Wrapper>
        ...
        <div className="flex-[2] flex flex-col items-center pb-[50px] md:-mt-14">
          ...
          <Link
            href="/"
            className="py-4 px-8 rounded-full bg-primary text-primary-foreground text-lg font-medium transition-transform active:scale-95 mb-3 hover:opacity-75 mt-8"
          >
            Continue Shopping
          </Link>
        </div>
